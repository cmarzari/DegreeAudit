...
public class MathandPhys {
    public static int MathandPhys(List MathandPhysClasses, HashMap MathandPhysList){
        ...
        System.out.println("MATH and PHYS Classes you still have to take:");
        System.out.println(Arrays.toString(notTakenMathandPhys.toArray()));   
        
        FinalOut();
        return MathandPhysCredits;
    }
}
